...
var getCard = function (info) {
  ...
  offerCard.querySelector('h4').textContent = window.offerType[info.offer.type];
  ...
  var featuresList = window.getRandomFeatures(window.OfferInfo.FEATURES, window.randomArrayLength);
